...
function SearchForm() {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    // Create a new URL object and set the search parameters using the values from the form state object and the dates we just formatted
    ...
    // Push the search URL to the router query string to trigger the search page to fetch the results from the URL object we just created above
